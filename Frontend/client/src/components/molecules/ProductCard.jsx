...
function ProductCard({ product }) {
  return (
    <div className="bg-white shadow-md rounded-xl overflow-hidden my-4 ">
      <div className="max-w-xs p-2 flex flex-col justify-between">
        ...
        <div className="mt-2 flex justify-between">
          <Button label="Buy" className="bg-pink-500 text-white text-xs px-2 py-2 rounded hover:bg-pink-600" />
          <Button label="Add to cart" className="bg-purple-500 text-white text-xs px-2 py-2 rounded hover:bg-purple-600" />
        </div>
      </div>
    </div>
  );
